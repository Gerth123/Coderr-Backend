...
class Order(models.Model):
    ...
    title = models.CharField(max_length=255, blank=True)  # blank=True erlaubt leere Werte
    ...
    features = models.JSONField(blank=True, null=True)  # JSONField erlaubt auch null
